...
colonne_da_escludere = ['ALL_Uniq', 'urban_area', 'urban_area_rel', 'eolico_std', 'solar_std']
...
colonne_dispersioni=['IslandArea', 'Popolazione', 'Densità_pop','eolico', 'gdp', 'gdp_procapite', 'temp', 'prec', 'solar_pow']
...
#Il modello spiega questa quota di varianza: [0.24937856 0.20594229]
#Il modello spiega questa quota di varianza: [0.24937856 0.20594229 0.08975708]
#Il modello spiega questa quota di varianza: [0.24937856 0.20594229 0.08975708 0.07742465]